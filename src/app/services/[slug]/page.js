...
export default function ServiceDetailPage() {
  ...
  const serviceContent = {
    'app-development': {
      ...
      description: 'We craft high-performance, scalable, and visually stunning applications for mobile, web, and cross-platform solutions. Our team combines design thinking with cutting-edge technology to deliver seamless user experiences.',
       features: [
    ...
    'web-development': {
      ...
      description: 'Building fast, responsive, and user-friendly websites tailored to your needs.',
  ...
  return (
    <div className=" min-h-screen mt-8">
      <section className="text-center py-20 bg-primary-bg">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-700"></p>
      </section>
      <section className="py-16 px-6 max-w-6xl mx-auto">
        ...
        <Text variant='p'>We believe in delivering excellence through creativity, innovation, and attention to detail. 
          Our team ensures every project is tailored specifically to your needs, blending aesthetic 
          appeal with functionality for the best possible results.</Text>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {content.features.map((feature, index) => (
              <div key={index} className="bg-white shadow-lg p-6 rounded-xl hover:shadow-2xl transition duration-300">
      ...
      <section className="py-20 px-6  bg-gray-50">
        ...
        <div className="space-y-10">
          {['Research & Planning', 'Creative Design', 'Development & Execution', 'Delivery & Support'].map((step, index) => (
      ...
      <section className="py-20 text-center bg-[#608BC1] text-white">
        ...
        <a href="/contact" className="bg-white text-[#b72960] px-6 py-3 rounded-lg font-semibold hover:bg-pink-100 transition">
          Contact Us
        </a>
      </section>
    </div>
